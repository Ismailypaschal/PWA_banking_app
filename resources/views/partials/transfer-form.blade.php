<div class="flex-auto p-6">
    <form role="form text-left" method="POST" action="/transaction/" onsubmit="return checkAccountName()();">
        <div class="mb-4">
            <input type="text" name="bankname" required
                ...
                placeholder="Bank name" aria-label="Name" aria-describedby="email-addon" />
        </div>
        <div class="mb-4">
            <input type="text" name="accountname" required 
                class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                placeholder="Account name" aria-label="Name" aria-describedby="email-addon"/>
            </div>
            <div class="mb-4">
                <input type="number" name="accountnumber" required id="acc-name"
                class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                placeholder="Account number" aria-label="Password" aria-describedby="password-addon" />
                <span id="check"></span>
        </div>
        <div class="mb-4">
            <input type="number" required name="amount"
                class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                placeholder="Amount to transfer" aria-label="Email" aria-describedby="email-addon" />
        </div>
        <div class="mb-4">
