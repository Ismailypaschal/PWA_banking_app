    ...
    <form method="POST" action="">
        <main class="flex-1 overflow-y-auto custom-scrollbar">
            <div class="px-4 pt-6 pb-2">
                ...
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Select your preferred way to fund your
                    account
                </p>
            </div>
            <div class="px-4 py-4 space-y-4">
                ...
                <details
                    ...
                    <div
                        ...
                        <div
                            class="flex justify-between items-center bg-white dark:bg-background-dark/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800">
                            <div class="flex flex-col">
                                <span class="text-[10px] uppercase font-bold text-slate-400">Account Number /
                                    IBAN</span>
                ...
                <details
                    ...
                    <div
                        class="p-6 bg-slate-50 dark:bg-[#1c273d] border-t border-slate-100 dark:border-slate-700 text-center">
                        <p class="text-sm text-slate-600 dark:text-slate-400 mb-4">Complete your deposit via the mobile
                            app.
                        </p>
                        <button
                ...
                <details
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="text-xs text-blue-700 dark:text-blue-300">Contact support to receive specific
                                wire
                ...
                {{-- amount --}}
                {{-- <div
                    class="relative rounded-xl bg-white dark:bg-[#192233] border border-slate-200 dark:border-slate-800 shadow-s px-4 py-4 focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all shadow-sm">
