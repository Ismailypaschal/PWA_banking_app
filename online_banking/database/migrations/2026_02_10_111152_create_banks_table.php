...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('transfers', function (Blueprint $table) {
            ...
            $table->string('bene_account_name')->nullable();
            ...
            $table->enum('account_type', ['savings', 'current', 'checking', 'investment'])->nullable();
            $table->enum('transfer_type', ['wire', 'domestic', 'paypal', 'cashapp', 'crypto', 'zelle']);
        ...
        Schema::create('cards', function (Blueprint $table) {
            ...
            $table->enum('status', ['active', 'freeze', 'blocked', 'pending', 'expired'])->default('active');
